...
const Ol = styled.ol`
  ...
  color: var(--muted-foreground); // Replace with your color variable
  /* @media (min-width: 640px) {
    gap: 2.5rem; // Adjust to your design
  } */
`;
...
const BreadcrumbLink = React.forwardRef<  HTMLAnchorElement,
...
const BreadcrumbPage = React.forwardRef(
  ({ className, ...props }, ref) => (
    <Span ref={ref} className={className} role="link" aria-disabled="true" aria-current="page" {...props} />
  )
);
...
const BreadcrumbEllipsis = ({ className, ...props }) => (
  <Ellipsis role="presentation" aria-hidden="true" className={className} {...props}>
